			<div id="nav">
				...
				<div id="nav-fixed">
					<div class="container">
						<!-- logo -->
						<div class="nav-logo">
							<a href="index.php" class="logo"><img src="./img/logouet.png" alt=""></a>
						</div>
						<!-- /logo -->
						...
						<ul class="nav-menu nav navbar-nav">
							...
							<li><a href="blank.php">Popular</a></li>
							<?php foreach ($menu_categories as $cate) {
							?>
							<li class="cat-<?php echo $cate["id"] % 4 + 1 ?>"><a href="category.php?id=<?php echo $cate["id"] ?>"><?php echo $cate["title"] ?></a></li>
						    <?php } ?>
						</ul>
						<!-- /nav -->
